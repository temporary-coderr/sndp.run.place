...
const url=`https://api.github.com/repos/${temporory-coderr}/${sndp.run.place}/contents/${path}`;
let sha;
...
const url=`https://api.github.com/repos/${temporary-coderr}/${sndp.run.place}/contents/${path}`;
